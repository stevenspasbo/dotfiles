...
(setq user-full-name "Steven Spasbo"
      ...
      scroll-preserve-screen-position 'always ) ;; might want to change this
...
(let ((my-packages
       '(use-package diminish hipster-theme moe-theme zenburn-theme
          ...
          farmhouse-theme material-theme afternoon-theme  gotham-theme doom-themes))
      (refreshed? nil))
...
(define-key global-map (kbd "M-g g") 'helm-do-grep-ag)
...
(use-package company
  ...
  (setq company-minimum-prefix-length 2
        ...
        company-global-modes '(not org-mode erc-mode eshell-mode))
...
(use-package cc-mode
  ...
  (add-hook 'c-mode-hook
            (lambda ()
              (set
               (make-local-variable 'company-backends) '(company-c-headers company-irony company-clang company-cmake company-keywords company-dabbrev)))))
