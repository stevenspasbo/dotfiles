;;; mymonokai-theme.el --- A fruity color theme for Emacs.

;; Copyright (C) 2011-2013

;; Author: Kelvin Smith <oneKelvinSmith@gmail.com>
;; URL: http://github.com/oneKelvinSmith/mymonokai-emacs
;; Version: 0.2.0
...
;;; Commentary:
;;
;; A port of the popular Textmate theme Mymonokai for Emacs 24, built on top
;; of the new built-in theme support in Emacs 24.
;;
;;; Credits:
;;
;; Wimer Hazenberg created the original theme.
;; - http://www.mymonokai.nl/blog/2006/07/15/textmate-color-theme/
;;
...
;;
;; K. Adam Christensen for his personal mymonokai theme that addresses 256 colours.
;; - https://github.com/pope/personal/blob/master/etc/emacs.d/mymonokai-theme.el
;;
...
(unless (>= emacs-major-version 24)
  (error "The mymonokai theme requires Emacs 24 or later!"))

(deftheme mymonokai "The Mymonokai colour theme")

(defgroup mymonokai nil
  "Mymonokai theme options.
The theme has to be reloaded after changing anything in this group."
  :group 'faces)

(defcustom mymonokai-distinct-fringe-background nil
  "Make the fringe background different from the normal background color.
Also affects 'linum-mode' background."
  :type 'boolean
  :group 'mymonokai)

(defcustom mymonokai-use-variable-pitch t
  "Use variable pitch face for some headings and titles."
  :type 'boolean
  :group 'mymonokai)

(defcustom mymonokai-high-contrast-mode-line nil
  "Make the active/inactive mode line stand out more."
  :type 'boolean
  :group 'mymonokai)

(defcustom mymonokai-height-minus-1 0.8
  "Font size -1."
  :type 'number
  :group 'mymonokai)

(defcustom mymonokai-height-plus-1 1.1
  "Font size +1."
  :type 'number
  :group 'mymonokai)

(defcustom mymonokai-height-plus-2 1.15
  "Font size +2."
  :type 'number
  :group 'mymonokai)

(defcustom mymonokai-height-plus-3 1.2
  "Font size +3."
  :type 'number
  :group 'mymonokai)

(defcustom mymonokai-height-plus-4 1.3
  "Font size +4."
  :type 'number
  :group 'mymonokai)
...
(let* ((class                    '((class color) (min-colors 257)))
       ...
       ;; Adaptive colors
       (mymonokai-fg               "#F8F8F2")
       (mymonokai-bg               "#202020") ;; #272822
       (mymonokai-hl-line          "#3E3D31")
       (mymonokai-hl               "#49483E")
       (mymonokai-emph             "#F8F8F0")
       (mymonokai-comments         "#75715E")
       ;; Adaptive higher/lower contrast accented colors
       (mymonokai-fg-hc            "#141414")
       (mymonokai-fg-lc            "#171A0B")
       ...
       (s-variable-pitch         (if mymonokai-use-variable-pitch
                                     'variable-pitch 'default))
       (s-fringe-bg              (if mymonokai-distinct-fringe-background
                                     mymonokai-hl mymonokai-bg))
       (s-mode-line-fg           (if mymonokai-high-contrast-mode-line
                                     mymonokai-bg mymonokai-fg))
       (s-mode-line-bg           (if mymonokai-high-contrast-mode-line
                                     mymonokai-fg mymonokai-hl-line))
       (s-mode-line-buffer-id-fg (if mymonokai-high-contrast-mode-line
                                     'unspecified green))
       (s-mode-line-inactive-fg  (if mymonokai-high-contrast-mode-line
                                     mymonokai-fg mymonokai-comments))
       (s-mode-line-inactive-bg  (if mymonokai-high-contrast-mode-line
                                     mymonokai-hl-line mymonokai-bg))
       (s-mode-line-inactive-bc  (if mymonokai-high-contrast-mode-line
                                     mymonokai-fg mymonokai-hl-line))
       ...
       ;; Adaptive colors
       (terminal-mymonokai-fg               "#F5F5F5")
       (terminal-mymonokai-bg               "#1B1E1C")
       (terminal-mymonokai-hl-line          "#212121")
       (terminal-mymonokai-hl               "#303030")
       (terminal-mymonokai-emph             "#FFFAFA")
       (terminal-mymonokai-comments         "#8B8878")
       ;; Adaptive higher/lower contrast accented colors
       (terminal-mymonokai-fg-hc            "#171A0B")
       (terminal-mymonokai-fg-lc            "#141414")
       ;; High contrast colors
       ...
       ;; customize based face properties
       (terminal-s-variable-pitch         (if mymonokai-use-variable-pitch
                                              'variable-pitch 'default))
       (terminal-s-fringe-bg              (if mymonokai-distinct-fringe-background
                                              terminal-mymonokai-hl terminal-mymonokai-bg))
       (terminal-s-mode-line-fg           (if mymonokai-high-contrast-mode-line
                                              terminal-mymonokai-bg terminal-mymonokai-fg))
       (terminal-s-mode-line-bg           (if mymonokai-high-contrast-mode-line
                                              terminal-mymonokai-fg terminal-mymonokai-hl-line))
       (terminal-s-mode-line-buffer-id-fg (if mymonokai-high-contrast-mode-line
                                              'unspecified terminal-green))
       (terminal-s-mode-line-inactive-fg  (if mymonokai-high-contrast-mode-line
                                              terminal-mymonokai-fg terminal-mymonokai-comments))
       (terminal-s-mode-line-inactive-bg  (if mymonokai-high-contrast-mode-line
                                              terminal-mymonokai-hl-line terminal-mymonokai-bg))
       (terminal-s-mode-line-inactive-bc  (if mymonokai-high-contrast-mode-line
                                              terminal-mymonokai-fg terminal-mymonokai-hl-line)))
  ...
  (custom-theme-set-faces
   ...
   ;; basic coloring
   `(default
      ((,class (:foreground ,mymonokai-fg
                            :background ,mymonokai-bg))
       (,terminal-class (:foreground ,terminal-mymonokai-fg
                                     :background ,terminal-mymonokai-bg))))

   `(shadow
     ((,class (:foreground ,mymonokai-comments))
      (,terminal-class (:foreground ,terminal-mymonokai-comments))))

   `(match
     ((,class (:background ,mymonokai-hl
                           :foreground ,mymonokai-emph
                           :weight bold))
      (,terminal-class (:background ,terminal-mymonokai-hl
                                    :foreground ,terminal-mymonokai-emph
                                    :weight bold))))

   `(cursor
     ((,class (:foreground ,mymonokai-bg
                           :background ,mymonokai-fg
                           :inverse-video t))
      (,terminal-class (:foreground ,terminal-mymonokai-bg
                                    :background ,terminal-mymonokai-fg
                                    :inverse-video t))))
   ...
   `(cua-global-mark
     ((,class (:background ,yellow
                           :foreground ,mymonokai-bg))
      (,terminal-class (:background ,terminal-yellow
                                    :foreground ,terminal-mymonokai-bg))))
   ...
   `(cua-rectangle-noselect
     ((,class (:inherit region
                        :background ,mymonokai-hl
                        :foreground ,mymonokai-comments))
      (,terminal-class (:inherit region
                                 :background ,terminal-mymonokai-hl
                                 :foreground ,terminal-mymonokai-comments))))
   ...
   `(ecb-source-in-directories-buffer-face
     ((,class (:inherit ecb-directories-general-face
                        :foreground ,mymonokai-fg))
      (,terminal-class (:inherit ecb-directories-general-face
                                 :foreground ,terminal-mymonokai-fg))))
   ...
   `(ecb-tree-guide-line-face
     ((,class (:inherit ecb-default-general-face
                        :foreground ,mymonokai-hl
                        :height 1.0))
      (,terminal-class (:inherit ecb-default-general-face
                                 :foreground ,terminal-mymonokai-hl
                                 :height 1.0))))

   ;; ee
   `(ee-bookmarked
     ((,class (:foreground ,mymonokai-emph))
      (,terminal-class (:foreground ,terminal-mymonokai-emph))))
   ...
   `(vertical-border
     ((,class (:foreground ,mymonokai-hl))
      (,terminal-class (:foreground ,terminal-mymonokai-hl))))
   ...
   `(font-latex-italic-face
     ((,class (:inherit italic :foreground ,mymonokai-emph))
      (,terminal-class (:inherit italic :foreground ,terminal-mymonokai-emph))))
   ...
   `(font-latex-sectioning-0-face
     ((,class (:inherit font-latex-sectioning-1-face
                        :height ,mymonokai-height-plus-1))
   ...
   `(font-latex-slide-title-face
     ((,class (:inherit (,s-variable-pitch font-lock-type-face)
                        :weight bold
                        :height ,mymonokai-height-plus-3))
   ...
   `(font-latex-subscript-face
     ((,class (:height ,mymonokai-height-minus-1))
      (,terminal-class (:height ,mymonokai-height-minus-1))))
   ...
   `(cfw:face-title
     ((,class (:inherit ,s-variable-pitch
                        :foreground ,yellow
                        :weight bold
                        :height ,mymonokai-height-plus-4))
      (,terminal-class (:inherit ,terminal-s-variable-pitch
                                 :foreground ,terminal-yellow
                                 :weight bold
                                 :height ,mymonokai-height-plus-4))))
   ...
   `(ctbl:face-cell-select
     ((,class (:background ,mymonokai-hl
                           :foreground ,mymonokai-emph
                           :underline ,mymonokai-emph
                           :weight bold))
      (,terminal-class (:background ,terminal-mymonokai-hl
                                    :foreground ,terminal-mymonokai-emph
                                    :underline ,terminal-mymonokai-emph
                                    :weight bold))))
   ...
   `(diff-header
     ((,class (:background ,mymonokai-bg))
      (,terminal-class (:background ,terminal-mymonokai-bg))))
   ...
   `(ediff-even-diff-A
     ((,class (:background ,mymonokai-comments
                           :foreground ,mymonokai-fg-lc ))
      (,terminal-class (:background ,terminal-mymonokai-comments
                                    :foreground ,terminal-mymonokai-fg-lc ))))

   `(ediff-odd-diff-A
     ((,class (:background ,mymonokai-comments
                           :foreground ,mymonokai-fg-hc ))
      (,terminal-class (:background ,terminal-mymonokai-comments
                                    :foreground ,terminal-mymonokai-fg-hc ))))
   ...
   `(gnus-x-face
     ((,class (:background ,mymonokai-fg
                           :foreground ,mymonokai-bg))
      (,terminal-class (:background ,terminal-mymonokai-fg
                                    :foreground ,terminal-mymonokai-bg))))
   ...
   ;; hl-line-mode
   `(hl-line
     ((,class (:background ,mymonokai-hl-line
                           :inherit t))
      (,terminal-class (:background ,terminal-mymonokai-hl-line
                                    :inherit t))))
   ...
   `(markdown-header-face-3
     ((,class (:inherit markdown-header-face
                        :height ,mymonokai-height-plus-2))
      (,terminal-class (:inherit markdown-header-face
                                 :height ,mymonokai-height-plus-2))))
   ...
   `(org-agenda-structure
     ((,class (:foreground ,mymonokai-emph
                           ...
                           :height ,mymonokai-height-plus-1
                           :underline nil
                           :box (:line-width 2 :color ,mymonokai-bg)))
      (,terminal-class (:foreground ,terminal-mymonokai-emph
                                    :background ,terminal-mymonokai-hl
                                    :weight bold
                                    :slant normal
                                    ...
                                    :height ,mymonokai-height-plus-1
                                    :underline nil
                                    :box (:line-width 2 :color ,terminal-mymonokai-bg)))))
   ...
   `(org-agenda-date
     ((,class (:foreground ,mymonokai-comments
      ...
      (,terminal-class (:foreground ,terminal-mymonokai-comments
                                    ...
                                    :slant normal
                                    :height 1.0
                                    :box (:line-width 2 :color ,terminal-mymonokai-bg)))) t)
   ...
   `(org-agenda-date-today
     ((,class (:inherit org-agenda-date
      ...
      (,terminal-class (:inherit org-agenda-date
                                 ...
                                 :box unspecified
                                 :foreground ,terminal-blue
                                 :background ,terminal-mymonokai-bg))) t)
   ...
   ;; parenface
   `(paren-face
     ((,terminal-class (:foreground ,mymonokai-comments))))
   ...
   `(popup-scroll-bar-foreground-face
     ((,class (:background ,mymonokai-emph))
      (,terminal-class (:background ,terminal-mymonokai-emph))))
   ...
   `(yascroll:thumb-text-area
     ((,class (:foreground ,mymonokai-comments
                           :background ,mymonokai-comments))
      (,terminal-class (:foreground ,terminal-mymonokai-comments
                                    :background ,terminal-mymonokai-comments))))
   ...
   `(zencoding-preview-input
     ((,class (:background ,mymonokai-hl
                           :box ,mymonokai-emph))
      (,terminal-class (:background ,terminal-mymonokai-hl
                                    :box ,terminal-mymonokai-emph)))))

  (custom-theme-set-variables
   'mymonokai
   `(ansi-color-names-vector [,mymonokai-bg ,red ,green ,yellow
                                          ,blue ,magenta ,cyan ,mymonokai-fg])

   ;; compilation
   `(compilation-message-face 'default)

   ;; fill-column-indicator
   `(fci-rule-color ,mymonokai-hl)
   ...
   `(highlight-tail-colors
     ((,mymonokai-hl . 0)(,green-lc . 20)(,cyan-lc . 30)(,blue-lc . 50)
      (,yellow-lc . 60)(,orange-lc . 70)(,magenta-lc . 85)(,mymonokai-hl . 100)))
   ...
   ;; weechat
   `(weechat-color-list
     (unspecified ,mymonokai-bg ,mymonokai-hl
                  ,red-d ,red
                  ,green-d ,green
                  ,yellow-d ,yellow
                  ,blue-d ,blue
